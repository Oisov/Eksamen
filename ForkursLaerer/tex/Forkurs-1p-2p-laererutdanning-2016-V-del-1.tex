...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    ...
    \end{tikzpicture}
    \caption{}
    \label{subfig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-6a}
  \end{subfigure}\hfill%
  \begin{subfigure}[b]{0.55\textwidth}
    ...
    \vspace*{-0.8cm}
    \caption{}
    \label{subfig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-6b}
  \end{subfigure}\hfill%
  \caption{}
  \label{fig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-6}
\end{figure}
...
\begin{figure}[H]
  ...
  \tikzsetnextfilename{Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-6}
  ...
  \end{tikzpicture}
  \caption{}
  \label{fig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-7}
\end{figure}

Gitt \cref{fig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-1-7}. $AC=12$,
