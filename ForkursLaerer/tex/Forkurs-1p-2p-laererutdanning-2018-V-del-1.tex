...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{apples.png}
\end{figure}
...
kan benytte. \Cref{tab:Forkurs-1p-2p-laererutdanning-2018-V-U-oppgave-1-4}
...
\begin{figure}[H]
  \centering
  \tikzsetnextfilename{Forkurs-1p-2p-laererutdanning-2018-V-U-oppgave-1-5}
  \begin{tikzpicture}
    \edef\BCxAB{2}
    \edef\ArealABC{10}
...
$AB$. Se \cref{fig:Forkurs-1p-2p-laererutdanning-2018-V-U-oppgave-1-5} ovenfor.
Bestem lengden av $AB$.
...
\begin{figure}[H]
  \centering
  \tikzsetnextfilename{Forkurs-1p-2p-laererutdanning-2018-V-U-oppgave-1-6}
  \begin{tikzpicture}
    \begin{axis}[
      Eksamen1,
      ytick={0,1,...,8},
...
spleise på utgiftene. Ovenfor ser du grafen til en funksjon $f$. Grafen i
\cref{fig:Forkurs-1p-2p-laererutdanning-2018-V-U-oppgave-1-6} viser sammenhengen
mellom hvor mange elever som blir med på festen, og prise hver elev må betale.
...
\begin{oppgaver}
  \Item{3} Skriv av \cref{tab:Forkurs-1p-2p-laererutdanning-2018-V-oppgave-1-8}
