...
\begin{table}[H]
  \newcommand{\tbnum}[1]{\multirow{-2}{*}{$\num{#1}$}}
    \centering
    \caption{}
    \label{tab:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-3}
...
\begin{oppgaver}
  \Item{2} Bruk regresjon til å bestemme en eksponentiell modell som viser
    ...
    \label{delopg:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-3a}
\end{oppgaver}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-5-picnic.png}
  \caption{}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-5-threeLogs.png}
  \caption{}
...
I \cref{tab:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-7} ser du et
...
I \cref{fig:Forkurs-1p-2p-laererutdanning-2016-V-oppgave-2-8} ser du de tre
