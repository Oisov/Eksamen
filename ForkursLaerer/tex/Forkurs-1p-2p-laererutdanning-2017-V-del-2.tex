...
\begin{oppgaver}
    \Item{2} Bestem den gjennomsnittlige vekstfarten til funksjonen $f$ fra $x = 1$ til $x = 12$ Hvilken praktisk informasjon gir dette svaret?
\end{oppgaver}
...
\begin{oppgaver}
    \Item{3} Hvor mange svarte kvadrater trenger du dersom du skal lage en figur med totalt $7225$ kvadrater?
\end{oppgaver}
